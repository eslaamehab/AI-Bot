	 ...
	 static class TH {
			...
			public static boolean applyPlan(String grid, String solution) {
				...
				for (int i = 0; i < actions.length; i++) {
					...
					case "up":
						linkin = s.f2();
						System.out.println(linkin+" up");
						break;
					case "down":
						linkin = s.f3();
						System.out.println(linkin+" down");
						break;
					case "right":
						linkin = s.f4();
						System.out.println(linkin+" right");
						break;
					case "left":
						linkin = s.applyLeft();
						System.out.println(linkin+" left");
						break;
					case "carry":
						linkin = s.f209();
						System.out.println(linkin+" carry");
						break;
					case "drop":
						linkin = s.f220();
						System.out.println(linkin+" drop");
						break;
					case "fly":
						linkin = s.f320();
						System.out.println(linkin+" fly");
						break;
					case "takePill":
						linkin = s.f32();
						System.out.println(linkin+" takepill");
						break;
					case "kill":
						linkin = s.f100();
						System.out.println(linkin+" kill");
						break;
				...
				//System.out.println("s.m23: " + s.m23 + " Doors: " + doors + " " + (s.m23 == doors));
				System.out.println(s.m23 == doors); //kills
				System.out.println(s.m10.size() == blue); //deaths
				System.out.println("OURS (blue) : " + blue);
				System.out.println("Theirs s.m10.size: " + s.m10.size());
